...
let SpotifyClientID = "dd05395b44bf46eb8538e30eb26e32c9"
let SpotifyRedirectURL = URL(string: "spotify-quick-start-final://spotify-login-callback")!
...
var connectButton = ConnectButton(title: "CONNECT")
var hostButton = ConnectButton(title: "HOST")
var guestButton = ConnectButton(title: "GUEST")
...
// var albumArtwork: UIImage = UIImage(named: "spotify")!
...
class AppDelegate: UIResponder, UIApplicationDelegate, SPTSessionManagerDelegate, SPTAppRemoteDelegate, SPTAppRemotePlayerStateDelegate {
    ...
    func appRemoteDidEstablishConnection(_ appRemote: SPTAppRemote) {
        ...
        let spotifyImage: UIImage = UIImage(named: "spotify")!
        imageView.image = spotifyImage
